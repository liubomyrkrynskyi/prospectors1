            ...
            <div className={"container"}>
                <div className={"mg_container"}>
                    <div className={"mg_info_block "}>
                        ...
                        <div className={"mg_container"}>
                            <p>
                                Plunge into the 19th century Gold Rush atmosphere from your device! This exciting game
                                of strategy gives players endless opportunities to earn crypto gold by utilizing
                                blockchain technology. Here you can start a business and explore a world teeming with
                                resources there for the taking.
